...
/**
 * trim_str - remove leading and trailing spaces from string.
 * @str: string input.
 * Return: void.
 */
...
void trim_str(char *str)
{
	...
	for (i = str_leng(str) - 1; i > 0 && (str[i] == ' ' || str[i] == '\t'); i--)
		str[i] = '\0';
}


/**
 * _reallocat - reallocates a memory block using malloc and free
 * @ptr: pointer void
